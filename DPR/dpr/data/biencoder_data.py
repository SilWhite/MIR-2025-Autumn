...
def get_dpr_files(source_name) -> List[str]:
    ...
    elif not os.path.isabs(source_name) and os.path.exists(os.path.join(get_original_cwd(), source_name)):
        return glob.glob(os.path.join(get_original_cwd(), source_name))
    else:
